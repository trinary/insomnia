...
module.exports.convert = async function(rawData) {
  ...
  return [workspace, baseEnv, openAPI, ...endpoints];
};

/**
 * Parse string data into openAPI 3.0 object
 *
 * @param {string} rawData
 *
 * @returns {Object|null} OpenAPI 3.0 object
 */
...
/**
 * Create request definitions based on an OpenAPI document.
 *
...
function generateParameterExample(schema) {
  ...
  if (schema instanceof Object) {
    const { format, example, default: defaultValue } = schema;
